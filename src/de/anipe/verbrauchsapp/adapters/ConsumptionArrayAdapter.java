...
public class ConsumptionArrayAdapter extends ArrayAdapter<Consumption> {
	...
	public ConsumptionArrayAdapter(Context context, int resource, List<Consumption> consumptions) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.liter.setText(new DecimalFormat("#.00").format(consumption.getRefuelliters()));
		holder.price.setText(new DecimalFormat("#0.000").format(consumption.getRefuelprice()));
		holder.cons.setText(new DecimalFormat("#0.00").format(consumption.getConsumption()));
