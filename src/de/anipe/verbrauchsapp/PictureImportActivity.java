...
public class PictureImportActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Toast.makeText(PictureImportActivity.this, "Fehler beim Öffnen der Datenbank!", Toast.LENGTH_LONG).show();
		}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (bitMap.getByteCount() > MAX_FILE_SIZE) {
			Toast.makeText(this, "Datei darf maximal 1 MBte groß sein!", Toast.LENGTH_LONG).show();
		} else {
